...
import re
import time
cookie='__cfduid=dc8603d98c1b7027705a38d798f593e9c1605241305; _ga=GA1.2.1659073861.1605241306; _gid=GA1.2.1335797918.1605886691; Hm_lvt_ed618df76d54605d45b765fc0ce862e6=1605254430,1605508838,1605528938,1605886691; Hm_lpvt_ed618df76d54605d45b765fc0ce862e6=1605886697'
...
#url2="http://www.acgjc.com/yy/112585.html"
    ...
    #name=html0.xpath('//*[@id="post-112752"]/h2[@class="entry-title"]/text()')
    #print(name)
...
#x1("http://www.acgjc.com/yy/112752.html")
...
def x3(url3):
    with open ('final_test.csv',"a+",encoding="utf-8-sig") as f2:
        l,t,n=x2(url3)
        f2.write("{},{},{}".format(n,l,t))
        f2.write("\n")

#x3('http://www.acgjc.com/storage-download/?code=MGMyZWRlQnRNSkJRcGhYaXROdklIMVA4SS9xdC93Z1dtMExsQVVMVTkvaHJBU25hbitzaHpyc0s4VHpRRzRV')
"""
